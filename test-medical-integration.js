...
async function testMedicalIntegration() {
  ...
  try {
    console.log('🏥 Testing Complete Medical Records Integration...');
    console.log('==================================================');
    ...
    console.log(`✅ Doctors retrieved - User: ${doctorsUser.data.count}, Admin: ${doctorsAdmin.data.count}`);
    ...
    // 4. Test Medical Reports (User & Admin)
    console.log('\n📄 Testing Medical Reports...');
    const reportsUser = await axios.get(`${API_BASE_URL}/medical/reports`, userHeaders);
    const reportsAdmin = await axios.get(`${API_BASE_URL}/admin/medical/reports`, adminHeaders);
    
    console.log(`✅ Reports retrieved - User: ${reportsUser.data.count}, Admin: ${reportsAdmin.data.count}`);

    // Test adding a medical report (Admin only)
    const newReport = await axios.post(`${API_BASE_URL}/admin/medical/reports`, {
      user_id: '1',
      doctor_id: doctorId,
    ...
    console.log('✅ New medical report added successfully');
    ...
    await axios.delete(`${API_BASE_URL}/admin/medical/reports/${reportId}`, adminHeaders);
    console.log('✅ Medical report deleted');
    ...
    console.log('  ✅ Medical Reports Management (CRUD)');
